# I had to switch my directories,
# in order for my data to be pulled
...
os.chdir(
    r"C:\Users\Trini\Documents\SDSU Big Data Analytics\
    Machine Learning\HW 1\Download files"
)
...
fig = px.bar(
    data_iris, x="sepal_width", y="Sepal_Length", color="class", barmode="group"
)
fig.show()
...
# I split the data to avoid data leackage.
# Not that it matters but it runs :p
